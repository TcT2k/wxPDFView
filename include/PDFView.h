...
public:
	...
	bool LoadFile(const wxString& fileName, const wxString& password = wxEmptyString);

	bool LoadStream(wxSharedPtr<std::istream> pStream, const wxString& password = wxEmptyString);
